      ...
      "0": {
        ...
        "parts": {
		  ...
		  "value": "${centralGroupPrefix}-logs",
              ...
              "settings": {
                "content": {
                  "Query": "let cloudRoleName = \"airflow2-scheduler\";\nlet airflowContainerName = \"airflow-scheduler\";\nKubePodInventory\n| where ControllerName contains cloudRoleName\n| extend InstanceName = strcat(ClusterId, '/', ContainerName), ContainerName = strcat(ControllerName, '/', tostring(split(ContainerName, '/')[1])), PodName = Name\n| where PodName contains cloudRoleName\n| where ContainerName has airflowContainerName\n| project Computer, InstanceName, ContainerName, PodName, PodStatus, TimeGenerated\n| extend Count = case (PodStatus == \"Running\", 1,\n        0)\n| parse kind=regex PodName with partitionId \"-airflow2-scheduler-[[:graph:]]\"\n| extend clusterName = case(partitionId == \"\", \"common-cluster\",\n                       partitionId)\n| extend PodName = case(clusterName == \"common-cluster\", strcat(clusterName, \"-\", PodName),\n    PodName)\n| summarize HostCount = avg(Count) by HostName = strcat(clusterName, \"-\", cloudRoleName), TimeGenerated, clusterName, PodName, PodStatus\n| render timechart;\n",
                  "PartTitle": "Healthy Host Count",
                  "Dimensions": {
                    "aggregation": "Sum",
                    "splitBy": [
		  ...
		  "value": "${centralGroupPrefix}-logs",
              ...
              "settings": {
                "content": {
                  "Query": "let cloudRoleName = \"airflow2-worker\";\nlet airflowContainerName = \"airflow-worker\";\nKubePodInventory\n| where ControllerName contains cloudRoleName\n| extend InstanceName = strcat(ClusterId, '/', ContainerName), ContainerName = strcat(ControllerName, '/', tostring(split(ContainerName, '/')[1])), PodName = Name\n| where PodName contains cloudRoleName\n| where ContainerName has airflowContainerName\n| project Computer, InstanceName, ContainerName, PodName, PodStatus, TimeGenerated\n| extend Count = case (PodStatus == \"Running\", 1,\n        0)\n| parse kind=regex PodName with partitionId \"-airflow2-worker-[[:graph:]]\"\n| extend clusterName = case(partitionId == \"\", \"common-cluster\",\n                       partitionId)\n| extend PodName = case(clusterName == \"common-cluster\", strcat(clusterName, \"-\", PodName),\n    PodName)\n| summarize HostCount = avg(Count) by HostName = strcat(clusterName, \"-\", cloudRoleName), TimeGenerated, clusterName, PodName, PodStatus\n| render timechart;\n",
                  "PartTitle": "Healthy Host Count",
                  "Dimensions": {
                    "aggregation": "Sum",
                    "splitBy": [
        ...
        "filters": {
          "value": {
            "MsPortalFx_TimeRange": {
              ...
              "filteredPartIds": [
                "StartboardPart-LogsDashboardPart-73c299a6-e344-4a29-b84b-aba6f878f80f",
                "StartboardPart-LogsDashboardPart-73c299a6-e344-4a29-b84b-aba6f878f811",
                "StartboardPart-LogsDashboardPart-73c299a6-e344-4a29-b84b-aba6f878f813",
                "StartboardPart-LogsDashboardPart-73c299a6-e344-4a29-b84b-aba6f878f817",
                "StartboardPart-LogsDashboardPart-73c299a6-e344-4a29-b84b-aba6f878f819",
                "StartboardPart-LogsDashboardPart-73c299a6-e344-4a29-b84b-aba6f878f81b",
                "StartboardPart-LogsDashboardPart-73c299a6-e344-4a29-b84b-aba6f878f81f",
                "StartboardPart-LogsDashboardPart-73c299a6-e344-4a29-b84b-aba6f878f821",
                "StartboardPart-LogsDashboardPart-73c299a6-e344-4a29-b84b-aba6f878f823",
                "StartboardPart-LogsDashboardPart-73c299a6-e344-4a29-b84b-aba6f878f827",
                "StartboardPart-LogsDashboardPart-73c299a6-e344-4a29-b84b-aba6f878f829",
                "StartboardPart-LogsDashboardPart-73c299a6-e344-4a29-b84b-aba6f878f82b",
                "StartboardPart-LogsDashboardPart-73c299a6-e344-4a29-b84b-aba6f878f82d",
                "StartboardPart-LogsDashboardPart-73c299a6-e344-4a29-b84b-aba6f878f831",
                "StartboardPart-LogsDashboardPart-73c299a6-e344-4a29-b84b-aba6f878f833",
                "StartboardPart-LogsDashboardPart-73c299a6-e344-4a29-b84b-aba6f878f835"
              ]
            },
