...
storage_container=${MAPPINGS_STORAGE_CONTAINER}
servicebus_topic_name="${RECORD_SERVICE_BUS_TOPIC}"
servicebus_topic_subscription="${RECORD_SERVICE_BUS_TOPIC_SUBSCRIPTION}"
...
export servicebus_topic_subscription="${RECORD_SERVICE_BUS_TOPIC_SUBSCRIPTION}"
export storage_service_endpoint="https://${ENV_HOST}/api/storage/v2"
