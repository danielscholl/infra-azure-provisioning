...
# ------------------------------------------------------------------------------------------------------
DELIVERY_HOST_LOCAL="http://localhost:${server_port}/api/delivery/v2/"
DELIVERY_HOST="https://${ENV_HOST}/api/delivery/v2/"
SEARCH_HOST="https://${ENV_HOST}/api/search/v2/"
...
export AUTHORIZE_API="${AUTHORIZE_API}"
export SEARCH_HOST="${SEARCH_HOST}"
export partition_service_endpoint="${partition_service_endpoint}"
...
# Integration Test Settings
# ------------------------------------------------------------------------------------------------------
#export DELIVERY_HOST="${DELIVERY_HOST_LOCAL}" switch to this to test locally
export DELIVERY_HOST="${DELIVERY_HOST}" # test deployed service by default
export SEARCH_HOST="${SEARCH_HOST}"
export STORAGE_HOST="${STORAGE_HOST}"
export LEGAL_HOST="${LEGAL_HOST}"
...
DELIVERY_HOST: "${DELIVERY_HOST_LOCAL}"
SEARCH_HOST: "${SEARCH_HOST}"
...
DEFAULT_DATA_PARTITION_ID_TENANT1: "${DEFAULT_DATA_PARTITION_ID_TENANT1}"
